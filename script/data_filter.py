...
功能说明
    ...
    筛选 random_list 文件中 t 坐标为 t0 + delta_t 的行，t x y z。
...
path_data = r''
path_filter = r'./test'
path_list = r'e:/project_data/file_selector/random_list_b0000.txt'
...
with open(path_list, 'r') as random_list:
...
for roots, dirs, files in file_filter:
    ...
    for file_name in files:
        ...
        # 提取文件名的坐标值
        # manual
        t, x, y, z = (int(file_name[i:i+num_len]) for i in num_pos)
        # auto
        ...
        data = {}
        # 读取数据文件
        with open(path_data + file_name, 'r') as data_file:
            # data_line = True
            # while data_line:
